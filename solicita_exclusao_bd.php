...
<body>
  <div class="wrap" role="main">
    ...
    <form action="<?= $BASE_URL ?>config/process.php" method="POST" id="create-form">
        <input type="hidden" name="type" value="solicita_exclusao">

      <label for="cpf">CPF</label>
      <div class="input-row">

        <input id="cpf" name="cpf" type="text" inputmode="numeric"  onkeyup="formatarCPF(this)" autocomplete="off" maxlength="14" placeholder="___.___.___-__" aria-label="CPF" required />
            <button type="submit" id="btn-cadastrar" class="btn btn-primary">Enviar</button>
      </div>
      <div id="feedback" aria-live="polite"></div>
      <p class="help">Caso haja um cadastro com esse cpf, será enviado um email de instrução para a conta de email cadastrada.</p>
    </form>
